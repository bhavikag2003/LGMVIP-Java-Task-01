...
public class ticTacToe {
	...
	private void initialize() {
		...
		xScore.setFont(new Font("Tahoma", Font.BOLD, 40));
		xScore.setHorizontalAlignment(SwingConstants.CENTER);
		xScore.setText("0");
		panel_4.add(xScore, BorderLayout.CENTER);
		...
		oScore.setFont(new Font("Tahoma", Font.BOLD, 40));
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(JOptionPane.showConfirmDialog(frame, "Confirm that you want to exit","Tic Tac Toe", JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION) {
					System.exit(0);
				}
			}
		});
